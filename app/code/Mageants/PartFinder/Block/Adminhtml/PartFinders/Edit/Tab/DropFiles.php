...
class DropFiles extends \Magento\Framework\View\Element\Template
{
    /**
     * Url path  to edit
     * 
     * @var string
     */
    const URL_PATH_CSV_UPLOAD = 'mageants_partfinder/partfinders/csvimport';
    /**
     * URL builder
     * 
	...
	{	
		...
		$this->setTemplate("Mageants_PartFinder::ImportFiles/dropFiles.phtml");
    }
     /**
     * getCsvImportUr
     * 
