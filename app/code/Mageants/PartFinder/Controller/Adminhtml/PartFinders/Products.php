...
class Products extends \Mageants\PartFinder\Controller\Adminhtml\PartFinders
{
	/**
     * Access Resource ID
     * 
     */
	const RESOURCE_ID = 'Mageants_PartFinder::partfinder_edit';
	/**
	 * 
	...
	public function execute()
    {
		...
		$resultLayout->getLayout()->getBlock('partfinder.partfinders.edit.tab.products');
