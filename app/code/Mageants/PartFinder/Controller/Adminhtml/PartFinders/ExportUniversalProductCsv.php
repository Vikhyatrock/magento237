...
class ExportUniversalProductCsv extends \Mageants\PartFinder\Controller\Adminhtml\PartFinders
{
	/**
     * Access Resource ID
     * 
    ...
    {		
		...
		$fileName = str_replace(" ","-",strtolower($partfinder->getName())). '-partfinder-universal-products.csv';
		
		$resultLayout = $this->_resultLayoutFactory->create();
		
		$content = $resultLayout->getLayout()->getBlock('partfinder.partfinders.edit.tab.universalproduct')->getCsv();
