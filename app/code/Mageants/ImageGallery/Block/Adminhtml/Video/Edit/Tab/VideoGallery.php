...
class VideoGallery extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    /**
    ...
    /*    $Lastfield = $fieldset->addField(
            ...
            array(
                ...
                'title' => __('Video'),
                'note' => 'Allow video type: mp4, avi, webm, flv, wmv, 3gp, ogg',
                'required' => true,
            )
        );*/
