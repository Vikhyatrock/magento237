...
namespace Mageants\PreOrder\Model\IsProductSalableForRequestedQtyCondition;
...
class IsAnySourceItemInStockCondition implements IsProductSalableForRequestedQtyInterface
{
    ...
    public function execute(string $sku, int $stockId, float $requestedQty): ProductSalableResultInterface
    {
        ...
        if (!$this->isAnySourceInStockCondition->execute($sku, $stockId)) {
            ...
            $stockItem = $objectManager->create('Magento\CatalogInventory\Api\Data\StockItemInterface');
                
            if ($preorder->getAlloweOutofproduct() == 1) {
