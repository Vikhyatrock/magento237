...
class Select extends CatalogSelect
{
        ...
        if ($_option->getType() == Option::OPTION_TYPE_RADIO ||
                ...
                case Option::OPTION_TYPE_RADIO:
                    ...
                    if (!$_option->getIsRequire()) {
                        $selectHtml .= '<li class="field choice admin__field admin__field-option">' .
                            ...
                            <input type="hidden" name="mgantsfastorder-options['.$sortOrder.']['.$_option->getId().']" class="mgantsproduct-custom-option-select" value="" />
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $selectHtml .= '<li class="field choice admin__field admin__field-option' .
                    ...
                    '" />' .
                    '<input type="hidden" name="'.$name.'" class="mgantsproduct-custom-option-select" value="'.$htmlValue.'" />
                    <label class="label admin__field-label" for="mgantsoptions_' .
                    $_option->getId() .
                    '_' .
                    $count .
    ...
    protected function getTypeMultiple($_option = null, $store = null, $configValue = null, $sortOrder = null)
    {
        ...
        $clone = '<input type="hidden" class="mgantsproduct-custom-option-select" name="mgantsfastorder-options['.$sortOrder.']['.$_option->getid().']" value=""/>';
