define([
    ...
    'mage/translate',
    'mage/validation',
], function ($, _, mageTemplate, priceUtils, cookie, customerData) {
    "use strict";
        ...
        _create: function () {
            ...
            $('#mgantsfastorder-form .mgantsaddline').click(function () {
                ...
                if (row < maxRow) 
                {
                    ...
                    var message = 'Maximum '+maxRow+' rows allowed.'
            ...
            $widget.xhr = $.ajax({
                ...
                error: function () {
                    ...
                    customerData.set('messages', {
                        messages: [{
                            type: 'error',
                            text: 'Something went wrong, please check CSV data and upload again.'
                        }]
                    });
                }
            });
