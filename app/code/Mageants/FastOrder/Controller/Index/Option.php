...
class Option extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($product->getTypeId()=='configurable') {
            ...
            $block1 = $layout->createBlock('Magento\ConfigurableProduct\Block\Product\View\Type\Configurable');
            $block1->setProduct($product);

            $block3 = $layout->createBlock('Magento\Swatches\Block\Product\Renderer\Configurable');
