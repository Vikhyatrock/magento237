 ...
 */
namespace Mageants\SimpleConfigurable\Ui\DataProvider\Product\Form\Modifier;
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'component' => 'Mageants_SimpleConfigurable/js/form/element/radio-set',
                                    'elementTmpl' => 'Mageants_SimpleConfigurable/form/components/radio-set',
                                    'dataType' => Form\Element\DataType\Text::NAME,
                                    'label' => __('Default'),
                                    'dataScope' => 'default_value',
                                    'dataName' => 'configurable-matrix[default]',
                                ],
                            ],
                        ],
                    ],
