 ...
 */
namespace Mageants\SimpleConfigurable\Controller\Product;
...
class Post extends ProductController implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        $getparentproductid = $objectManager->create(\Magento\ConfigurableProduct\Model\ResourceModel\Product\Type\Configurable::class)->getParentIdsByChild($productid);
        $getconfigproductid = implode(',', $getparentproductid);
        if(!empty($getconfigproductid)){
        $product = $objectManager->create(\Magento\Catalog\Model\Product::class)->load($getconfigproductid);
        }else{
