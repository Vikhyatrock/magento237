...
class Index extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Mageants_ExtraFee::extrafee');
    }
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Manage Fee'), __('Manage Fee'));
        $resultPage->getConfig()->getTitle()->prepend(__('Manage Fee'));
        return $resultPage;
    }
}
