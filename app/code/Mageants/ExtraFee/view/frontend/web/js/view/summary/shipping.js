    ...
    return Component.extend({
        ...
        getShippingMethodTitle: function() {
                ...
                else
                {
                    ...
                    //return shippingMethod ? shippingMethod.carrier_title + " - " + shippingMethod.method_title + " + "+ feeLabel : '';
                }
        ...
        getValue: function() {
                ...
                /*if(jQuery.cookie("shippingExtrafeeIds") != null && jQuery.cookie("shippingExtrafeeIds")!='') {
                    var price =  parseFloat(this.totals().shipping_amount)+parseFloat(jQuery.cookie("shippingExtrafeeIds"));
                }
                else{*/
                    var price =  this.totals().shipping_amount;
                /*}
                if(jQuery.cookie("mandatoryShippingAmount")!=null &&jQuery.cookie("mandatoryShippingAmount")!=''){
                    price = price + parseFloat(jQuery.cookie("mandatoryShippingAmount"));
                }*/
