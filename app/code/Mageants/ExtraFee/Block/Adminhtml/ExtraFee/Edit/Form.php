...
/**
 * Adminhtml extrafee edit form block
 *
 */
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \Mageants\ExtraFee\Helper\Data $helper,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'amount',
            'text',
            ['name' => 'amount', 'label' => __('Amount'), 'title' => __('Amount'), 'required' => true,'class'=>'validate-not-negative-number']
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'id' => 'apply_to',
                'required' => false,
                'options' => ['Product' => __('Product'), 'Category' => __('Category'),'Shipping' => __('Shipping'), 'Order' => __('Order')],
            ]
        );
