...
namespace Mageants\StoreCredit\Helper;

/**
 * Email class for Helper
 */
class Email extends \Magento\Framework\App\Helper\AbstractHelper
{
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'store_credit/email_notification/customer_notification_template';
    ...
    public function StoreCreditMailSend($emailTemplateVariables, $senderInfo, $receiverInfo)
    {
