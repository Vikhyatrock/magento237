	...
	protected function _prepareForm() {
		...
		$fieldset->addField(
			...
			[
				...
				'title' => __('Title Font Size'),
				'required' => false,
				'class' => 'validate-number',
				'note' => 'If blank then use default size is 75px And If you want to add size then only add number like 72,60 etc. Don\'t add 72px, 60px etc.',
			]
		);
		...
		if (isset($formData['image'])) {
			...
			$fieldset->addField(
				...
				[
					...
					'note' => "You need to upload image same height of sliders that you have set in Slider height field in Sliders grid [Only if you have Adaptive Height set to True ]",
				]
			);
