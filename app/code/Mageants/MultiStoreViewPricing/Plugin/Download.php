 ...
 */
namespace Mageants\MultiStoreViewPricing\Plugin;
...
class Download
{
    ...
    public function aroundExecute($result)
    {
        ...
        if ($result->getRequest()->getParam('filename')=='multi_store_view_pricing') {
            $moduleDir =$this->componentRegistrar
                ->getPath(ComponentRegistrar::MODULE, 'Mageants_MultiStoreViewPricing');
        }
        
        $fileAbsolutePath = $moduleDir . '/Files/Sample/' . $fileName; $directoryRead =
