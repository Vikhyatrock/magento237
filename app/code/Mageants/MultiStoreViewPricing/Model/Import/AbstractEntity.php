...
abstract class AbstractEntity
{
    ...
    protected function _saveValidatedBunches()
    {
        ...
        if (!empty($rowData) && !$startNewBunch) {
            $this->_dataSourceModel->saveBunch($this->getEntityTypeCode(), $this->getBehavior(), $rowData);
            $startNewBunch = true;
        }
