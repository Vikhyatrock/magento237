...
use Mageants\MultiStoreViewPricing\Model\Import\RowValidatorInterface as ValidatorInterface;
 ...
 */
class Import extends \Mageants\MultiStoreViewPricing\Model\Import\AbstractEntity
{
    ...
    {
        return 'multi_store_view_pricing';
    }
    ...
    {
        return $this->_resource->getTableName('multi_store_view_pricing');
    }
